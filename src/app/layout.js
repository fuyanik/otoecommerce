...
export const metadata = {
  title: "Otomotiv Sepeti - Motorsiklet & Otomotiv Ekipmanları",
  description: "Otomotiv Sepeti, kask, mont, eldiven, lastik ve motosiklet aksesuarları. Güvenli ve hızlı alışveriş.",
