    ...
    <footer className='w-full bg-gray-50'>
      ...
      <Image className='mt-4' src={footerlogo2} alt="Logo" width={140}  />
         <p className='text-center text-[13px] text-gray-500 mt-4'>
          <span className='font-bold' > Otomotiv Sepeti Limited Şirketi,</span> motorsiklet ve otomotiv tutkunlarına yönelik, kask, koruyucu giyim, eldiven, lastik ve aksesuar gibi ürünlerde uzmanlaşmış güvenilir bir e-ticaret platformudur. Kurulduğu günden itibaren müşterilerine hem güvenli hem de sorunsuz bir alışveriş deneyimi sunmak için modern altyapılar ve yüksek güvenlik standartlarıyla hizmet vermektedir.
         </p>
         <p className='text-center text-[13px] text-gray-500 mt-4'> <span className='font-bold' >  otomotivsepeti.com </span> üzerinden yapacağınız alışverişlerde kredi kartı bilgileriniz yalnızca ödeme işlemi sırasında kullanılır ve kesinlikle veri tabanında saklanmaz. Böylece ödeme bilgileriniz üçüncü tarafların erişimine karşı tamamen güvence altındadır.</p>
         <p className='text-center text-[13px] text-gray-500 mt-4'>Sitemizde gerçekleştirilen tüm işlemlerin gerçekten  <span className='font-bold' >  otomotivsepeti.com </span> sunucularına iletildiğini garanti altına almak için gelişmiş  <span className='font-bold' >  256 bit SSL sertifikası </span>  kullanılmaktadır. Bu teknoloji sayesinde aktardığınız tüm kişisel veriler şifrelenerek güvenli bir şekilde işlenir ve yetkisiz erişimlere karşı korunur.</p>
         <p className='text-center text-[13px] text-gray-500 mt-4'>Otomotiv Sepeti, kullanıcı güvenliğini temel ilke olarak benimser. Hem teknik altyapımızı hem de veri koruma sistemlerimizi düzenli olarak güncelleyerek güvenli alışveriş ortamını daima en üst seviyede tutarız. Amacımız; müşterilerimize hızlı, modern, şeffaf ve güven veren bir alışveriş deneyimi sunmak, satın aldığınız her ürünü sorunsuz şekilde size ulaştırmaktır.</p>
         <p className='text-center text-[13px] text-gray-500 mt-4'>Otomotiv Sepeti olarak, güvenli alışverişin standartlarını yükseltmeye ve kullanıcılarımıza her zaman konforlu bir deneyim sunmaya devam ediyoruz.</p>
  
  <div className='w-full mt-4 text-xs bg-black text-white p-3 rounded-md text-center'> ©2014-2025  OTOMOTİV SEPETİ "Otomotiv Sepeti Limited Şirketi" KURULUŞUDUR.</div>
      </div>
    </footer>
  );
}
